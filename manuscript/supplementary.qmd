...
![Per-subject high-grip force compliance (actual / target).](figures/hero_grip_compliance.png){#fig-supp-compliance width=85%}

![Subject-level accuracy drop under high versus low grip (caterpillar plot).](figures/hero_caterpillar.png){#fig-supp-caterpillar width=90%}

![Speed–accuracy trade-off under low versus high grip.](figures/hero_sat_tradeoff.png){#fig-supp-sat width=85%}
