...
De-identified behavioral data are available from the corresponding author upon reasonable request. Analysis code and study materials are available via Zenodo (https://doi.org/10.5281/zenodo.20950701) 

# Ethics Statement {.unnumbered}

All procedures were approved by the Institutional Review Board at the University of California, Riverside (Protocol No. HS-21-055). All participants provided written informed consent prior to participation.
...
This work was supported by NIA (Grant No. NIH/NIA R01AG072607). The funder had no role in study design, data collection, analysis, decision to publish, or manuscript preparation.
